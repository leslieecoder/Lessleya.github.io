...
#that takes no parameters and creates and returns a compound list that contains 
#all the data in the table of elements in the Problem Statement section above.
#The data within the compound table should be organized like this:
...
def make_periodic_table():
    ...
    #      print(f"The mass is: element.get('mass')]")
