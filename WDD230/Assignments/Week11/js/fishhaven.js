const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5585010&appid=a1ae1eb12eb3ea4848cc295aeda6d43d&units=imperial";
fetch(apiURL)
...
const forecast = "https://api.openweathermap.org/data/2.5/forecast?id=5585010&appid=a1ae1eb12eb3ea4848cc295aeda6d43d&units=imperial";
fetch(forecast)
    .then((response) => response.json())
    .then((jsObject) => {
        const weatherHead = document.getElementById("weatherTitle");
